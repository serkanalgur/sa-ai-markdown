...
// Define constants
define( 'SA_AI_MARKDOWN_VERSION', '1.0.2' );
 ...
 * Activation hook
 */
register_activation_hook( __FILE__, [ 'SA_AI_Markdown_Cron', 'activate' ] );

/**
 * Deactivation hook
 */
register_deactivation_hook( __FILE__, [ 'SA_AI_Markdown_Cron', 'deactivate' ] );
